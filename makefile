...
LDLIBS	= -lm -lrt -lpthread -lsodium $(EXTRA_LDFLAGS)
PRG	= ptp4l hwstamp_ctl nsm phc2sys phc_ctl pmc timemaster
FILTERS	= filter.o mave.o mmedian.o
SERVOS	= linreg.o ntpshm.o nullf.o pi.o servo.o
TRANSP	= raw.o transport.o udp.o udp6.o uds.o
OBJ	= bmc.o clock.o clockadj.o clockcheck.o config.o designated_fsm.o \
 e2e_tc.o fault.o $(FILTERS) fsm.o hash.o interface.o key.o msg.o phc.o \
 port.o port_signaling.o pqueue.o print.o ptp4l.o p2p_tc.o rtnl.o $(SERVOS) \
 sa.o sk.o stats.o tc.o $(TRANSP) telecom.o tlv.o tsproc.o unicast_client.o \
...
nsm: config.o $(FILTERS) hash.o interface.o key.o msg.o nsm.o phc.o print.o \
 rtnl.o sk.o $(TRANSP) tlv.o tsproc.o util.o version.o

pmc: config.o hash.o interface.o key.o msg.o phc.o pmc.o pmc_common.o print.o sk.o \
 tlv.o $(TRANSP) util.o version.o

phc2sys: clockadj.o clockcheck.o config.o hash.o interface.o key.o msg.o \
