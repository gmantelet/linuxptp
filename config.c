...
struct config_item config_tab[] = {
	...
	PORT_ITEM_INT("use_security", 0, 0, 1),
	GLOB_ITEM_STR("incoming_sa", "FF:FF:FF:FF:FF:FF:FF:FF.FFFF,FF:FF:FF:FF:FF:FF"),
	GLOB_ITEM_STR("outgoing_sa", "FF:FF:FF:FF:FF:FF:FF:FF.FFFF,FF:FF:FF:FF:FF:FF"),
